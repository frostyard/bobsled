...
This integration path is not yet projected into the main run ledger or operator UI. A separate conflict-resolution path and bounded fan-out must exist before the broader M5 execution item is complete.
